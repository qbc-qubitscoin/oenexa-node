# OenexaID Verifiable Credential Schema

**Version**: v1.0
**Phase**: 9 (OenexaID Development)

## Overview
The OenexaID system uses W3C-compatible Verifiable Credentials (VCs) to represent identity, KYC/AML status, and investor accreditation. To preserve privacy and maintain GDPR compliance, personally identifiable information (PII) is **never** stored on the OENEXA blockchain. Instead, off-chain VCs contain the PII, signed by trusted issuers (e.g., regulated KYC providers) using ML-DSA-65 keys. The blockchain only stores Decentralized Identifiers (DIDs) and cryptographic proofs (e.g., zero-knowledge proofs or credential hashes).
...
```json
{
  ...
  "issuer": "did:oen:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
  "issuanceDate": "2026-09-01T12:00:00Z",
  "expirationDate": "2027-09-01T12:00:00Z",
  "credentialSubject": {
    "id": "did:oen:fedcba9876543210fedcba9876543210fedcba9876543210fedcba9876543210",
    "kycStatus": "APPROVED",
    "amlRiskLevel": "LOW",
    "jurisdiction": "US",
  ...
  "proof": {
    ...
    "verificationMethod": "did:oen:0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef#keys-1",
...
```json
{
  ...
  "proof": {
    "type": "MLDSA65Signature2026",
    "proofPurpose": "assertionMethod",
    "verificationMethod": "did:oen:auditor-address-hex#keys-1",
    "jws": "..."
  }
}
```
